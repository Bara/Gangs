void configs_OnPluginStart()
{
    ...
    Config.NameMinLength = AutoExecConfig_CreateConVar("gangs_max_name_length", "2", "Minimal length of a gang name.", _, true, 2.0, false, _);
    ...
    Config.PrefixMinLength = AutoExecConfig_CreateConVar("gangs_max_prefix_length", "2", "Minimal length of a gang prefix.", _, true, 2.0, false, _);
